...
public class MagicBox extends JPanel implements Runnable, MouseListener {
	...
	public void mousePressed(MouseEvent e) {
		...
		//mediapalace.playSoundFromInternet("https://www.youtube.com/watch?v=QIkDyi6Pon8");
		...
		int orange = -2001142;
		if (mouseColor==blue) {
			mediapalace.speak("the fitnessgram pacer test is multistage aerobic capicity test");
		}
		if (mouseColor==gray) {
			mediapalace.speak("minecraft");
		}
	}
